...
h_eq_tilde_th = 8;             % Do beamsweeping as the calibration when 'abs(h_eq_tilde) < h_eq_tilde_th'
set_target_velocity = 0.3;        % m/s   2   5   5   1   0.2   0.3 0.4 0.5   1 1.5 0.3
        ...
        for k = 1:N_sc
            if Rx_Tx_turn_indicator == 1 % --------Rx
                ...
                if count_win_AoD == L_win_AoD % Potential error revised
                    ...
                    if (if_beamsweeping_cali == 1) && (temp_maximum_h_eq_tilde < h_eq_tilde_th) % Lost Target calibration   % special in AoD tracking proces
                        % Calibrating AoA and AoD
